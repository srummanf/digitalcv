...
// By: ph
// See: https://v0.app/icon/ph/read-cv-logo-duotone
// Example: <IconPhReadCvLogoDuotone width="24px" height="24px" style={{color: "#000000"}} />

export const IconPhReadCvLogoDuotone = ({
  height = "1em",
  fill = "currentColor",
  focusable = "false",
  ...props
